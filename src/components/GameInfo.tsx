...
export default function GameInfo({ gameState, humanPlayer }: GameInfoProps) {
  ...
  return (
    <div className="bg-white text-gray-800 rounded-lg p-4 space-y-4 shadow-md border border-gray-200">
      {/* 게임 상태 */}
      ...
      {currentPlayer && (
        <div className="text-center bg-gray-50 rounded-lg p-3 border border-gray-200">
          ...
          {currentPlayer.isTurn && (
            <div className="text-green-600 text-sm animate-pulse mt-2 bg-green-50 px-3 py-1 rounded-full border border-green-200">
              행동을 기다리고 있습니다...
            </div>
          )}
        </div>
